<%@ Page Language="C#"  MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CreateAccountSafetyHomeowner.aspx.cs" Inherits="CreateAccountSafetyHomeowner" %>
...
<div  class="container">
    ...
    <div class="row" style="margin-top: 7rem;">
        ...
        <p style="font-family: 'Oswald', sans-serif; color: #756664; font-size: 30px;"></p>    
                <div class="progress " >
